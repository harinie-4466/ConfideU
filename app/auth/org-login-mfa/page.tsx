...
export default function OrgLoginMFAPage() {
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="bg-card border border-border rounded-lg p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">Your organization login has been verified.</p>
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="bg-card border border-border rounded-lg p-8">
          <h1 className="text-2xl font-bold text-foreground mb-2 text-center">Verify Your Login</h1>
          ...
          <button
            onClick={() => {
              router.push('/login')
              localStorage.removeItem('confideU_login_org')
            }}
